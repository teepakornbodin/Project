...
const StockDeluxe = () => {
  ...
  const fetchRoomData = async () => {
    try {
      const response = await fetch(`/api/booking/room-type/DELUXE`, {
        headers: {
  ...
  return (
    <div className="w-full justify-center grid grid-flow-row mt-7">
        ...
        <div className="flex flex-col justify-center items-center ">
          <div className="place-items-center bg-gray-100 h-44 w-full rounded-2xl grid grid-flow-row ml-14 mr-14 drop-shadow-md ">
            <div>
              <p
